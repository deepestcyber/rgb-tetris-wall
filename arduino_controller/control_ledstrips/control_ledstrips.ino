...
#define MODEL WS2811 //WS2811, WS2812b
#define NUM_LEDS_H 16
#define NUM_LEDS_V 24 //24
#define NUM_BITS_VSTREAM 6
#define NUM_FRAMES_VSTREAM 50
#define FPS 20 //1000/NUM_FRAMES_VSTREAM
...
void loop() {
  ...
  if (mode == 3){
    String data = "";
    if (Serial.available()) {
      //char buf[NUM_BYTES_VSTREAM]
      //char buf[NUM_BYTES_VSTREAM] = Serial.read();
      //TODO: expext a byte of length
